...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final String WEATHER_LOCATION_QUERY_KEY = "location";
    private static final int WEATHER_SEARCH_LOADER = 69;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loader<String[]> weatherQueryLoader = loaderManager.getLoader(WEATHER_SEARCH_LOADER);
        if(weatherQueryLoader == null){
            getSupportLoaderManager().initLoader(WEATHER_SEARCH_LOADER, weatherBundle, callback);
        }
        else{
            loaderManager.restartLoader(WEATHER_SEARCH_LOADER, weatherBundle, callback);
        }
    }
