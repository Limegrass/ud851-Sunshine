...
//  DONE (1) Create a constant int value to identify the notification
    public static final int WEATHER_NOTIFICATION_ID = 420;
...
//          DONE (4) Use TaskStackBuilder to create the proper PendingIntent
            ...
            PendingIntent startDetailActivityPendingIntent =
                    taskStackBuilder.getPendingIntent(0,
                            PendingIntent.FLAG_UPDATE_CURRENT);

//          DONE (5) Set the content Intent of the NotificationBuilder
            builder.setContentIntent(startDetailActivityPendingIntent);
