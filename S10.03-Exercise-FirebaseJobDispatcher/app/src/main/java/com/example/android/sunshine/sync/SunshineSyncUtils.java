...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_INTERVAL_IN_HOURS = 3;
    private static final int SYNC_INTERVAL_IN_SECONDS = (int) TimeUnit.HOURS.toSeconds(SYNC_INTERVAL_IN_HOURS);
    private static final int SYNC_FLEX_IN_HOURS= 1;
    private static final int SYNC_FLEX_IN_SECONDS = (int) TimeUnit.HOURS.toSeconds(SYNC_FLEX_IN_HOURS);

    private static final String SYNC_TAG = "sync_weather";
...
//  TODO (12) Create a method to schedule our periodic weather sync
    private static void syncWeather(Context context){
        ...
        Job weatherSyncJob = firebaseJobDispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(SYNC_INTERVAL_IN_SECONDS,
                        SYNC_INTERVAL_IN_SECONDS + SYNC_FLEX_IN_SECONDS))
                .build();
