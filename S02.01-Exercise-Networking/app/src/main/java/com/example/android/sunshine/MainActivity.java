...
public class MainActivity extends AppCompatActivity {
    ...
    private class WeatherRequest extends AsyncTask<String, Void, String[]>
    {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL requestURL = NetworkUtils.buildUrl(params[0]);
            try
            {
                String results = NetworkUtils.getResponseFromHttpUrl(requestURL);
                String[] jsonData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, results);
                return jsonData;
