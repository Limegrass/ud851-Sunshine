...
//      TODO (8) Display the summary that you created above
        ...
        double tempHigh = mCursor.getDouble(MainActivity.INDEX_MAX_TEMP);
        double tempLow = mCursor.getDouble(MainActivity.INDEX_MIN_TEMP);
        String tempHighLow = SunshineWeatherUtils.formatHighLows(mContext, tempHigh, tempLow);
        String weatherDescription = dateString + " - " + weatherCondition +  " - " + tempHighLow;
